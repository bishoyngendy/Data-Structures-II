...
//		File input = new File("TestCases/dictionary.txt");
		File input = new File(path + "TestCases/dictionary.txt");
		dict.load(input);
...
//		File dictFile = new File("TestCases/dictionary.txt");
		File dictFile = new File(path + "TestCases/dictionary.txt");
		dict.load(dictFile);
//		File inputFile = new File("TestCases/queries.txt");
		File inputFile = new File(path + "TestCases/queries.txt");
...
//		File dictFile = new File("TestCases/dictionary.txt");
		File dictFile = new File(path + "TestCases/dictionary.txt");
		dict.load(dictFile);
		File inputFile = new File(path + "TestCases/deletions.txt");
		Scanner sc = new Scanner(inputFile);
...
//		Assert.assertEquals(15, dict.height());
		Assert.assertEquals(14, dict.height());
	}
